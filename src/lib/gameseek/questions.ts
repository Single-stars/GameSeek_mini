...
export const questions: Question[] = [
  {
    ...
    options: [
      { id: "A", text: "挑战和变强，靠技术或判断获得成就感", tags: ["skill_mastery", "system_mastery", "high_challenge"] },
      { id: "B", text: "进入一个故事、角色或世界", tags: ["story", "roleplay", "character_bond", "immersion"] },
      { id: "C", text: "探索、发现秘密、自己理解规则", tags: ["exploration", "discovery", "mystery", "low_guidance"] },
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "战斗、操作、闪避、瞄准或连招", tags: ["action_combat", "reflex", "aim", "combat_mastery"] },
      { id: "B", text: "规划、构筑、算收益、做取舍", tags: ["planning", "buildcraft", "strategy", "system_mastery"] },
  ...
  },
  {
    ...
    options: [
      ...
      { id: "B", text: "理解系统、找到最优策略", tags: ["planning", "optimization", "system_mastery"] },
      { id: "C", text: "观察线索、理解规则、推理真相", tags: ["observation", "deduction", "puzzle", "mystery"] },
      { id: "D", text: "长期建设、收集、养成，让世界慢慢变好", tags: ["long_term", "collection", "management", "cozy"] }
    ]
  },
  {
    id: "Q04_SOCIAL",
    ...
    options: [
      ...
      { id: "C", text: "固定朋友合作，一起通关或制造混乱", tags: ["fixed_coop", "teamwork", "coop", "chaos_fun"] },
      { id: "D", text: "真人匹配、排位、对抗、团队竞技", tags: ["pvp", "ranked", "team", "social_pressure"] }
    ]
  },
  {
    id: "Q05_PRESSURE",
  ...
  },
  {
    ...
    options: [
      ...
      { id: "C", text: "经营崩盘，重新规划资源", tags: ["management", "resource_pressure", "planning"] },
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "很重要，我愿意大量阅读或看剧情", tags: ["story", "heavy_text", "character_bond", "dialogue"] },
  ...
  },
  {
    ...
    prompt: "你对探索和自由度的偏好是？",
    options: [
      { id: "A", text: "大地图自由探索，自己发现路线", tags: ["open_world", "exploration", "low_guidance"] },
      { id: "B", text: "紧凑箱庭或关卡探索，不要太散", tags: ["compact_world", "guided", "adventure"] },
      { id: "C", text: "隐藏谜题、秘密、知识推进", tags: ["mystery", "discovery", "knowledge_progression", "puzzle"] },
  ...
  },
  {
    ...
    options: [
      ...
      { id: "B", text: "喜欢建造、装修、创造和自我表达", tags: ["building", "decoration", "self_expression", "sandbox"] },
      { id: "C", text: "喜欢生产链、自动化、资源优化", tags: ["factory", "automation", "optimization", "resource_chain"] },
  ...
  },
  {
    ...
    prompt: "你更喜欢怎样的游戏节奏？",
    options: [
      { id: "A", text: "5-15 分钟一局，快速反馈", tags: ["short_session", "fast_feedback"] },
  ...
  },
  {
    ...
    prompt: "你想要的主要情绪是？",
    options: [
      { id: "A", text: "刺激、爽快、兴奋", tags: ["hype", "fast_feedback", "action_combat"] },
      { id: "B", text: "安静、治愈、陪伴", tags: ["cozy", "low_pressure", "companionship"] },
