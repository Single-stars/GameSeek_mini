...
export const questions: Question[] = [
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "战斗、操作、闪避、瞄准或连招", tags: ["action_combat", "reflex", "aim", "combat_mastery", "battle_royale"] },
  ...
  },
  {
    ...
    options: [
      ...
      { id: "C", text: "观察线索、理解规则、推理真相", tags: ["observation", "deduction", "puzzle", "mystery", "spatial_logic", "physics"] },
  ...
  },
  {
    ...
    options: [
      ...
      { id: "C", text: "固定朋友合作，一起通关或制造混乱", tags: ["fixed_coop", "teamwork", "coop", "chaos_fun", "local_multiplayer", "mini_games", "party", "randomness"] },
  ...
  },
  {
    ...
    options: [
      ...
      { id: "C", text: "经营崩盘，重新规划资源", tags: ["management", "resource_pressure", "planning", "resource_management", "colony_sim", "systemic", "survival"] },
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "很重要，我愿意大量阅读或看剧情", tags: ["story", "heavy_text", "character_bond", "dialogue", "interactive_movie", "branching_story", "cinematic_choice", "cinematic"] },
  ...
  },
  {
    ...
    options: [
      ...
      { id: "C", text: "喜欢生产链、自动化、资源优化", tags: ["factory", "automation", "optimization", "resource_chain", "resource_management", "colony_sim", "systemic"] },
  ...
  },
  {
    ...
    prompt: "你更喜欢怎样的游戏节奏？",
    options: [
      { id: "A", text: "5-15 分钟一局，快速反馈", tags: ["short_session", "fast_feedback", "mini_games"] },
